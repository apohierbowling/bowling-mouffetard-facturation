...
- **Créer / Éditer** : formulaire avec lignes multiples (description, quantité, prix unitaire HT, TVA), calcul automatique des totaux, numérotation auto (`DEV-2026-001`, `FAC-2026-001`). Un menu permet d'ajouter une ligne directement depuis le catalogue de tarifs.
